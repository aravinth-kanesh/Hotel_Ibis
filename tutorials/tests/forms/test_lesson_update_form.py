...
class LessonUpdateFormTestCase(TestCase):
    def setUp(self):
        ...
        # Creates student, tutor, and language instances.
    ...
    def test_form_pre_filled_with_original_lesson_data(self):
        """Tests that the form is pre-filled with the original lesson details."""

        # Initialises the form with the lesson instance.
    ...
    def test_form_valid_when_cancel_lesson_checked(self):
        """Tests if the form is valid when the cancel lesson checkbox is selected."""
    ...
    def test_form_invalid_when_cancel_lesson_not_checked_and_no_new_date_or_time(self):
        """Tests if the form is invalid when the cancel lesson is not checked and no new date/time is provided."""
    ...
    def test_form_invalid_when_new_date_provided_but_no_new_time(self):
        """Tests if the form is invalid when new date is provided but no time is given."""
    ...
    def test_form_invalid_when_new_time_provided_but_no_new_date(self):
        """Tests if the form is invalid when new time is provided but no date is given."""
    ...
    def test_form_valid_when_cancel_lesson_checked_and_date_time_provided(self):
        """Tests if the form is valid when cancel lesson is checked and date/time are provided."""
    ...
    def test_form_invalid_when_date_and_time_not_changed(self):
        """Tests if the form is invalid when neither the date nor the time is changed."""
    ...
    def test_form_valid_with_full_lesson_data(self):
        """Tests if the form is valid with all the lesson fields filled, including reschedule."""
    ...
    def test_form_valid_when_only_date_is_changed(self):
        """Tests if the form is valid when only the date is changed."""
    ...
    def test_form_valid_when_only_time_is_changed(self):
        """Tests if the form is valid when only the time is changed."""
