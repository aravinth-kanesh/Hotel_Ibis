...
class MessageModelTest(TestCase):
    ...
    def setUp(self):
        ...
        def test_message_string_representation(self):
            """Tests the __str__ method of the Message model."""
        ...
        def test_message_creation(self):
            """Tests that a message is correctly created."""
        ...
        def test_reply_to_message(self):
            """Tests creating a reply to a message."""
        ...
        def test_message_querying(self):
            """Tests querying sent and received messages."""
        ...
        def test_delete_user_and_message_behavior(self):
            """Tests behavior when a sender or recipient user is deleted."""
            self.sender.delete()
        ...
        def test_meta_ordering(self):
            """Tests that messages are ordered by created_at in descending order."""
